...
class PostgresNode_Base(object):
    ...
    def child_processes(self):
        ...
        children = self._os_ops.get_process_children(self.pid)
    ...
    @property
    def logs_dir(self):
        raise NotImplementedError("PostgresNode_Base::logs_dir is not impelented")

    @property
    def data_dir(self):
        raise NotImplementedError("PostgresNode_Base::data_dir is not impelented")

    @property
    def utils_log_file(self):
        raise NotImplementedError("PostgresNode_Base::utils_log_file is not impelented")

    @property
    def pg_log_file(self):
        raise NotImplementedError("PostgresNode_Base::pg_log_file is not impelented")
    ...
    def _collect_log_files(self):
        ...
        for f in files:
            ...
            file_size = self._os_ops.get_file_size(f)
    ...
    def _detect_port_conflict(self, log_files0, log_files1):
        ...
        for file in log_files1.keys():
            ...
            file_content = self._os_ops.read_binary(file, read_pos)
